...
$(document).ready(function(data) {
    ...
    fileInput.fileinput().on('filepreupload', function(event, data, previewId, index) {
        ...
        var galleryIdInput = '<input ' +
            'type="hidden"' +
            ' name="'+ extraArray.formName + '[' + extraArray.attributeName + ']' + '[gallery_id]' +'"' +
            ' value="'+ extraArray.galleryId +'"' +
            ' class="gallery-hidden-' + extraArray.attributeName + '"' +
            ' >';
